...
const initialState: ITiposListbox | null = {
  CristalesDisenos: localStorage.getItem("ListBoxTipos.CristalesDisenos")
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.CristalesDisenos") as string
      )
    : [],
  CristalesMateriales: localStorage.getItem("ListBoxTipos.CristalesMateriales")
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.CristalesMateriales") as string
      )
    : null,
  CristalesIndices: localStorage.getItem("ListBoxTipos.CristalesIndices")
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.CristalesIndices") as string
      )
    : null,
  CristalesColores: localStorage.getItem("ListBoxTipos.CristalesColores")
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.CristalesColores") as string
      )
    : null,
  CristalesTratamientos: localStorage.getItem(
    "ListBoxTipos.CristalesTratamientos"
  )
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.CristalesTratamientos") as string
      )
    : null,

  AlmacenesTipos: localStorage.getItem("ListBoxTipos.AlmacenesTipos")
    ? JSON.parse(localStorage.getItem("ListBoxTipos.AlmacenesTipos") as string)
    : null,
  ...
  ArmazonesMaterial: localStorage.getItem("ListBoxTipos.ArmazonesMaterial")
    ...
    : null,
  ArmazonesTipos: localStorage.getItem("ListBoxTipos.ArmazonesTipos")
    ? JSON.parse(localStorage.getItem("ListBoxTipos.ArmazonesTipos") as string)
    : null,

  OTOpcionVentaArmazon: localStorage.getItem(
    "ListBoxTipos.OTOpcionVentaArmazon"
  )
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.OTOpcionVentaArmazon") as string
      )
    : null,
  OTOpcionVentaCristales: localStorage.getItem(
    "ListBoxTipos.OTOpcionVentaCristales"
  )
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.OTOpcionVentaCristales") as string
      )
    : null,
  OTTipoAnteojo: localStorage.getItem("ListBoxTipos.OTTipoAnteojo")
    ? JSON.parse(localStorage.getItem("ListBoxTipos.OTTipoAnteojo") as string)
    : null,
  OTAreas: localStorage.getItem("ListBoxTipos.OTAreas")
    ? JSON.parse(localStorage.getItem("ListBoxTipos.OTAreas") as string)
    : null,
  ...
  OTMotivo: localStorage.getItem("ListBoxTipos.OTMotivo")
    ...
    : null,
  OTMotivoGarantia: localStorage.getItem("ListBoxTipos.OTMotivoGarantia")
    ? JSON.parse(
  ...
  PuntosVentaTipos: localStorage.getItem("ListBoxTipos.PuntosVentaTipos")
    ? JSON.parse(
        localStorage.getItem("ListBoxTipos.PuntosVentaTipos") as string
      )
    : null,
...
export const fetchListBoxTipos = createAsyncThunk(
  "listBox/fetchListBoxTipos",
  async (token: any) => {
    try {
      const { data } = await axios(
        `${URLBackend}/api/tipos/listado/?query=02`,
        {
          headers: {
            Authorization: token,
          },
...
export const { updateDataForKey, clearLocalStorage } =
  listBoxTiposSlice.actions;
