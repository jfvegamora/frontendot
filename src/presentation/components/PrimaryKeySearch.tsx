...
const PrimaryKeySearch: React.FC<PrimaryKeySearchProps> = React.memo(
  ({ setEntities, primaryKeyInputs, updateParams, description, otHistorica, baseUrl,classNameSearchButton }) => {
    ...
    //   console.log(inputGroups[0].length)
    
    //   return (
    //     <table className="  w-full">
    //       <tbody className="w-[50%] items-center">
    //         <tr className={`${className}`}>
    //         { inputGroups && inputGroups[0]?.map((input, groupIndex) => (
    //               <td key={groupIndex} className="w-[80vw] items-center">
    //                 {input.type === "number" ? (
    //                   <div className={`input-container ${input.styles?.with ? input.styles.with : ""}`}>
    //                     {input.name === "_pEsferico" ? (
    //                       <div className={`flex !w-[14rem] ${input.styles?.container}`}>
    ...
    //                     </div>
    //                   ) : (
    //                     <div className={`input-container  bg-orange-600  ${input.styles?.container}`}>
    ...
    //                               className={`${
    //                                 input.styles?.labelProps ? input.styles?.labelProps : ""
    //                               } absolute text-orange-500   !translate-y-[-0.45vw] translate-x-3 !bg-white z-20`}
    //                             >
    //                               {input?.label}
    //                             </label>
    //                           <Input
    //                             type="date"
    //                             color="orange"
    //                             className={`labelInput w-[50%] ${input.styles?.styles}`}
    //                             {...field}
    //                             value={field.value || ""}
    //                             onChange={(e) => {
    //                               changeFilterSearchTitle(e, input.label);
    ...
    //                             className={`${
    //                               input.styles?.labelProps ? input.styles?.labelProps : ""
    //                             } absolute text-orange-500   !translate-y-[-0.45vw] translate-x-3  z-20`}
    //                           >
    //                             {input?.label}
    //                           </label>
    //                           <Input
    //                             color="orange"
    //                             tabIndex={1}
    //                             className={` labelInput  ${input?.styles?.with || ""}`}
    //                             {...field}
    //                             type={input.type}
    //                             value={inputValues[input.name]}
    //                             onChange={(e) => {
    ...
    //   // Agrupamos los inputs en filas de 6
    //   const inputGroups = [];
    //   for (let i = 0; i < primaryKeyInputs.length; i += 4) {
    //     inputGroups.push(primaryKeyInputs.slice(i, i + 4));
    //   }
    ...
    //             {group.map((input, inputIndex) => (
    //               <td key={inputIndex} className="w-[80vw] items-center">
    //                 {input.type === "number" ? (
    //                   <div className={`input-container ${input.styles?.with ? input.styles.with : ""}`}>
    //                     {input.name === "_pEsferico" ? (
    //                       <div className={`flex !w-[14rem] ${input.styles?.container}`}>
    ...
    //                     </div>
    //                   ) : (
    //                     <div className={`input-container w-full bg-orange-600 ${input.styles?.container}`}>
    //                       <SelectFilterInputComponent
    //                         label={input.label}
    //                         name={input.name}
    //                         showRefresh={true}
    ...
    //                             type="date"
    //                             color="orange"
    //                             className={`labelInput  ${input.styles?.styles}`}
    //                             {...field}
    //                             value={field.value || ""}
    //                             onChange={(e) => {
    //                               changeFilterSearchTitle(e, input.label);
