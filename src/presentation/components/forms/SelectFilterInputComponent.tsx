...
const SelectFilterInputComponent: React.FC<ISelectInputProps> = React.memo(
  ({
    label,
    control,
    name,
   ...
   if(name === 'Tipo Doc'){
    ...
    return (
      ...
      <div className={`flex items-center bg-red-300 translate-y-[0.3vw]  cursor-pointer ${customWidth ? customWidth : ""}`}>
...
export default SelectFilterInputComponent;
