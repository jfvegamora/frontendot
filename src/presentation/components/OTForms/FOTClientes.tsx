...
const FOTClientes:React.FC<IClientes> = ({
    ...
    const fetchCliente = async(cliente_rut:string) => {
        try {
            ...
            if (Array.isArray(cliente.data) && cliente.data.length === 1) {
                ...
                <div className="w-[31%] rounded-lg border -mt-14 border-blue-500 ml-8  mx-auto items-center grid relative">
                    ...
                    <label className='labelForm w-[25%] top-[-8%] left-[2%] pl-8 absolute z-10'>Direccion</label>
                        ...
                        <RegProCom
                         ...
                         control={control}
                         register={register}
                         defaultRegion={data && data[EnumGrid.cliente_region_id]}
                         defaultProvincia={data && data[EnumGrid.cliente_provincia_id]}
                         defaultComuna={data && data[EnumGrid.cliente_comuna_id]}
