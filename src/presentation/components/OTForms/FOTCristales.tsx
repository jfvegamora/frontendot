...
import { A1_CR_OD, A1_CR_OI, A1_GRUPO_OD, A1_GRUPO_OI, A2_CR_OD, A2_CR_OI, A2_Diametro, A2_GRUPO_OD, A2_GRUPO_OI, codigoProyecto, EmpresaAdjudicadaOT_ID, inputOnlyReadBodegaProcesado, tipo_anteojo_title, tipo_anteojo_title_cristal2, tipo_de_anteojo, validacionIncompleta, validar_cristal1_od, validar_cristal1_oi, validar_cristal2_od, validar_cristal2_oi } from '../../utils';
    ...
    return (
        <form onKeyDown={handleKeyDown}>
            <div className='flex frameOTForm h-[85vh] '>
                ...
                <div className={`${tipo_de_anteojo.value !== '3' ? 'translate-x-[20vw]' : ''}    w-[48vw] relative !mt-[2.5rem] !h-[80vh] `}>
                    <div className=" flex items-center radioComponent   h-[75vh] w-[97%] !ml-[1rem]">
                        <div className="mx-auto !mt-6 w-[50vw] !h-full ">
                            <h1 className={`absolute z-10 top-[-6%] text-3xl font-bold ${tipo_de_anteojo.value !== '3' ? 'w-[30vw] translate-x-[-8vw]' : 'w-[20vw] translate-x-[2vw]'}   text-center !text-[#f8b179] left-[34%] `}>ANTEOJO {tipo_anteojo_title.value.toUpperCase()}</h1>
