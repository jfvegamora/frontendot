    ...
    <div className="useFormContainer centered-div w-[35rem]">
      ...
      <form className="userFormulario" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="input-container items-center rowForm w-[65%]">
              <div className="labelInputDiv">
                <TextInputComponent
                  ...
                  data={
                    isMasivo
                      ? dataPendiente && dataPendiente[0]?.proyecto
                      : dataPendiente &&
                        dataPendiente[EnumPendiente.proyecto_titulo]
                  }
                  onlyRead={true}
        ...
        <div className="flex justify-center">
          <Button type="submit" className="otActionButton bg-yellow-700">
            Pausar
          </Button>
        </div>
      </form>
