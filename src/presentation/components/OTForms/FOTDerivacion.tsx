...
const FOTDerivacion: React.FC<IDerivacion> = ({
  ...
  const onSubmit: SubmitHandler<FormData> = async (jsonData) => {
    ...
    if (data[EnumGrid.estado_id] === 25) {
      return toast.error(
        `Folio ${data[EnumGrid.folio]} se encuentra en Stand-By.`
      );
    }
    ...
    <div className="useFormContainer centered-div w-[35rem]">
      ...
      <form className="userFormulario" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="input-container items-center rowForm w-[65%]">
              <div className="labelInputDiv">
                <TextInputComponent
                  ...
                  data={
                    isMasivo
                      ? dataDerivacion && dataDerivacion[0]?.proyecto
                      : data && data[EnumDerivacion.proyecto_titulo]
                  }
                  onlyRead={true}
            ...
            <div className="input-container items-center rowForm w-[50%]">
              <div className="labelInputDiv">
                <TextInputComponent
                  ...
                  data={
                    isMasivo
                      ? OTAreas["areas"].filter(
                          (areas: any) => areas[1] === OTAreas["areaActual"]
                        )[0][2]
                      : data && data[EnumDerivacion.area]
                  }
                  onlyRead={true}
                  customWidth={"labelInput inputStyles"}
                />
        ...
        <div className="flex justify-center">
          <Button type="submit" className="otActionButton bg-red-900">
            Derivar
          </Button>
        </div>
