...
// import { EnumGrid } from "../mantenedores/MMuestrariosArmazones2";
...
//   let _p1 = `"${jsonData.proyecto}", ${jsonData.punto_venta},  ${jsonData.almacen},  ${jsonData.estado === "Disponible" ? 1 : 2}`;
