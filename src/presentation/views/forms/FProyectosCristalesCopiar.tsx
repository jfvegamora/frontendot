...
const FProyectosCristalesCopiar: React.FC<IUserFormPrps> = React.memo(
  ({ closeModal, setEntities, params, label, isEditting, escritura_lectura }) => {
    ...
    // const intId = data && [data[EnumGrid.codigo_cristal, EnumGrid.]];
    const {
      control,
      handleSubmit,
      formState: { errors },
...
export default FProyectosCristalesCopiar;
