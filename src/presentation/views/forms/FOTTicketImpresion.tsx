        ...
        {(
             ...
             <div className="w-full ">
               <div className="!h-auto">
                 ...
                 <p className="border-b-2   ml-4 border-black mx-auto -mt-2">{OT[0] && OT[0][EnumGrid.cliente_nomnbre]} </p> 
               </div>
             </div>
             ...
             <div className="w-full !-mt-2">
               <div className="h-auto">
                   ...
                   <p className="border-b-2  ml-4 border-black mx-auto -mt-2 ">{OT[0] && OT[0][EnumGrid.proyecto_titulo]} </p>
               </div>
             </div>
             ...
             <div className="w-full flex justify-around !-mt-2">
               <div className="w-[45%] ml-2">
                 ...
                 <p className="border-b-2 -mt-2 mb-2 border-black mx-auto ">{parsedDate(OT[0] && OT[0][EnumGrid.fecha_atencion])} </p>
               </div>
               <div className="w-[40%] ml-4 ">
                 <h2 className='font-bold text-base'>Fecha Entrega: </h2>
                 <p className="border-b-2 -mt-2  border-black mx-auto ">{parsedDate(OT[0] && OT[0][EnumGrid.fecha_entrega_cliente])} </p>
               </div>
             </div>
