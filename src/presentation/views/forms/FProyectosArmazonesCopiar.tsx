...
import { validationParametrizacionArmazonesCopiar } from "../../utils/validationFormSchemas";
...
const FProyectosArmazonesCopiar: React.FC<IUserFormPrps> = React.memo(
  ({ closeModal, setEntities, params, label, data, isEditting, escritura_lectura }) => {
    const schema = validationParametrizacionArmazonesCopiar();
  ...
  //  },[changeCodigo])
    ...
    // useEffect(() => {
    //   isEditting ? focusSecondInput("estado") : focusFirstInput("proyecto_origen");
    // }, []);
