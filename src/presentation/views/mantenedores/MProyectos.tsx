...
export enum EnumGrid {
  ...
  EJECUTIVO_ID                    = 26,
  EJECUTIVO                       = 27,
  CONTACTO_ADMINISTRADOR_NOMBRE   = 28,
  CONTACTO_ADMINISTRADOR_CORREO   = 29,
  CONTACTO_ADMINISTRADOR_TELEFONO = 30,
  REFERENTE_TECNICO_NOMBRE        = 31,
  REFERENTE_TECNICO_CORREO        = 32,
  REFERENTE_TECNICO_TELEFONO      = 33,
  CONTACTO_CONTABILIDAD_NOMBRE    = 34,
  CONTACTO_CONTABILIDAD_CORREO    = 35,
  CONTACTO_CONTABILIDAD_TELEFONO  = 36,
  CONTACTO_FINANZAS_NOMBRE        = 37,
  CONTACTO_FINANZAS_CORREO        = 38,
  CONTACTO_FINANZAS_TELEFONO      = 39,
  OFTALMOLOGO_ID                  = 40,
  OFTALMOLOGO                     = 41,
  OBSERVACIONES                   = 42,
  IMPRIME_QR                      = 43,
