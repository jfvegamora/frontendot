...
const MProyectosTratamAdic: React.FC = () => {
  ...
  useEffect(() => {
    const newPkToDelete = selectedRows.map(
      (row: number) =>
        `{"proyecto":"${
          entities[row][EnumGrid.proyecto_id]
        }", "tratamiento_adicional":"${
          entities[row][EnumGrid.tratamiento_adicional_id]
        }"}`
    );
            ...
            primaryKeyInputs={[
              ...
              },
              {
                ...
                styles: {
                  ...
                  container:
                    "!w-[40vw]  text-[1vw] translate-x-[12vw] translate-y-[0.3rem] ",
                  labelProps: "labelInput",
                },
              },
            ]}
