...
const MPizarraArchivo: React.FC = () => {
  ...
  return (
    <div className="mantenedorContainer">
      ...
      <div className="overflow-x-scroll h-[77%]">
        <TablePizarra
          data={entities}
          tableHead={table_head_pizarra_archivo}
          idMenu={idMenu}
        />
      </div>
    </div>
...
export default MPizarraArchivo;
