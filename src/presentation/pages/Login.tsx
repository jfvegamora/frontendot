...
const Login: React.FC = React.memo(() => {
  ...
  if (isLoading) {
    return (
      ...
      <div className="">
        <div className="flex items-center justify-center h-[20vh] translate-y-[20vw]">
          <Spinner className="h-20 w-20" style={{ color: "#f39c12" }} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="loginFormContainer mx-auto w-[90%] md:w-[50%] lg:w-[40%] xl:w-[30%] !mt-[18vh]">
      <h1 className="userFormLabel text-white pt-10 text-2xl md:text-2xl lg:text-3xl xl:text-3xl">
        Sistema Gestión OT
      </h1>
            ...
            <div className="input-container items-center  mt-4">
              <div className="w-[90%] mx-auto">
                <Button
                  type="submit"
                  tabIndex={1}
                  className="userFormBtnSubmit !mt-8"
                >
                  Entrar
                </Button>
                <Link
                  className="text-white block text-center !mt-[1rem]"
                  to="/forgotpassword"
                >
