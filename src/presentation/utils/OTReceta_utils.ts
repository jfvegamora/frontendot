...
export const setDioptriasReceta = (name: string, value: any) => {
  const [prefix, section, subfield] = name.split("_") as [
    string,
    keyof DioptriasReceta,
    keyof DioptriasReceta[keyof DioptriasReceta]
  ];
  const completeSection = `${prefix}_${section}` as keyof DioptriasReceta;

  if (
    completeSection in dioptrias_receta.value &&
    subfield in dioptrias_receta.value[completeSection]
  ) {
...
export const validation_tipo_anteojo = () => {
  ...
  const mappingNivel3: any = {
    "1": {
      validar_cristal1_od: 0,
      validar_cristal1_oi: 0,
      validar_cristal2_od: 1,
      validar_cristal2_oi: 1,
      validar_armazon1: 0,
      validar_armazon2: 1,
    },
    "2": {
    ...
    "3": {
      validar_cristal1_od: 0,
      validar_cristal1_oi: 0,
      validar_cristal2_od: 0,
      validar_cristal2_oi: 0,
      validar_armazon1: 0,
      validar_armazon2: 0,
    },
    "4": {
  ...
  const mapping: any = {
    ...
    "3": {
      ...
      a2_oi_eje: 0,
      cristal2_marca_id: 0,
      cristal2_diseno_id: 0,
      cristal2_indice_id: 0,
      cristal2_material_id: 0,
      cristal2_color_id: 0,
      cristal2_diametro: 0,
      cristal2_tratamiento_id: 0,
      cristal2_od: 0,
      cristal2_oi: 0,
      a2_armazon_id: 0,
    },
  ...
  deshabilitarCampo.value.a2_dp = tipoDeAnteojo === "3" ? true : false;
...
export const combinaciones_validas = () => {
  const item = validationNivel1.value.find(
    (item) => item.campo === "combinaciones_validas"
  );
